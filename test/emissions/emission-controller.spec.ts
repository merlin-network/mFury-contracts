...
describe("EmissionsController", async () => {
    ...
    /**
     * Deploys the emission controller, staking contracts, dials and transfers FURY to the Emission Controller contract.
     *
    ...
    const deployEmissionsController = async (topLevelConfig: TopLevelConfig = MCCP24_CONFIG): Promise<void> => {
        ...
        // Transfer FURY into the Emissions Controller
    ...
    describe("deploy and initialize", () => {
        ...
        it("transfer FURY on initialization", async () => {
