...
describe("Feeder - Swap", () => {
     ...
     * @param inputAsset feeder, mFury or main pool asset to swap from sender and into the pool
     * @param outputAsset feeder, mFury or main pool asset to swap to sender and out of the pool
    ...
    describe("swapping assets", () => {
        context("when within the invariant validator limits", () => {
            ...
            context("passing invalid arguments", async () => {
                ...
                it("should fail to swap mFury asset for main pool asset", async () => {
                    await assertFailedSwap("Invalid pair", details.pool, details.mAsset, details.mAssetDetails.bAssets[0], 10)
                })
                it("should fail to swap main pool asset for mFury asset", async () => {
