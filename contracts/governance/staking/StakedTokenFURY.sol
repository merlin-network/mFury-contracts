...
/**
 * @title StakedTokenFURY
 * @dev Derives from StakedToken, and simply adds the functionality specific to the $FURY staking token,
 * for example compounding rewards.
 **/
contract StakedTokenFURY is StakedToken, Initializable {
     ...
     * for example, with $FURY as both staking token and rewards token. Calls 'claimRewards' on the HeadlessStakingRewards
