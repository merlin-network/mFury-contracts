...
subtask("vault-snap", "Dumps user data for a vault")
    ...
    .addOptionalParam("asset", "Symbol of the asset that has a mFury vault. eg mUSD, alUSD, MTA", "mUSD", types.string)
...
subtask("vault-stake", "Stake into a vault")
    .addParam("asset", "Symbol of the asset that has a mFury vault. eg mUSD, alUSD, MTA", undefined, types.string)
